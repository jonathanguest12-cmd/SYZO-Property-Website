      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-8">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            <p className="text-2xl font-bold tracking-[0.06em] text-white">SYZO Ltd</p>
            <p className="mt-3 text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.5)' }}>
              Premium shared living across the South West. Beautifully furnished rooms in professionally managed houses.
            </p>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <div className="mt-4 flex flex-col gap-2.5 text-sm" style={{ color: 'rgba(255,255,255,0.7)' }}>
              <a href="tel:01174504898" className="transition-colors duration-200 hover:text-white">
                0117 450 4898
              </a>
              <a href="mailto:hello@syzo.co" className="transition-colors duration-200 hover:text-white">
                hello@syzo.co
              </a>
